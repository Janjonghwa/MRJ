...
- #### 👤 이상형 스펙 공개 (${partnerGender} 기준):
  ㄴ **외형 (심층 분석)**: 
    ...
    - **동물상**: 강아지상, 고양이상, 토끼상, 여우상, 곰상, 공룡상, 사슴상, 호랑이상, 늑대상, 곰상, 코끼리상, 기린상, 펭귄상, 오리상, 돼지상, 소상, 말상, 양상, 원숭이상, 쥐상, 용상, 뱀상, 닭상, 돼지상, 소상, 말상, 원숭이상, 쥐상, 용상, 뱀상 등 한 가지를 콕 짚어서 비유
    - **체형**: 근육질, 슬림탄탄, 슬림, 탄탄한 근육, 푸근하고 듬직함 ,글래머러스, 마른, 통통한 등 아주 구체적으로 묘사
    - **분위기 & 스타일**: (예: 무신사 깔끔룩, 스트리트 감성, 포멀한 정장핏 등)
  ㄴ **내면**: 성격, 가치관, 대화 스타일
  ㄴ **직업군/라이프스타일**: (예: 테크 기업 실무자, 자유로운 프리랜서 등)
- #### 📅 인연 터지는 시기 (연도/월 단위로)
