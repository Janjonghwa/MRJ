...
- #### 👤 이상형 스펙 공개 (${partnerGender} 기준):
  ㄴ **외형 (심층 분석)**: 
    ...
    - **비주얼**: 동물상(해당 동물 이모지 같이 출력), 체형, 스타일을 생생하게 묘사.
      (🚨경고: "여우상 🦊", "잔근육", "고양이상" 같은 뻔한 표현은 너무 많이 쓰임. 토끼상 🐰, 사슴상 🦌, 늑대상 🐺, 공룡상 🦖, 햄스터상 🐹, 뱀상 🐍, 곰상 🐻, 흑표범상 🐆, 쿼카상 🐿️ 등 수많은 동물상 중에서 사주에 맞춰 무작위로 고를 것. 체형 역시 "듬직한", "비율 깡패", "마른장작", "근육질 골리앗", "여리여리핏", "체대생 피지컬" 등 매번 다른 창의적 묘사를 사용할 것)
    - **내면**: 성격, 가치관, 대화 스타일의 확실한 캐릭터성
    - **라이프스타일**: 구체적이고 현대적인 직업 및 라이프스타일
    
    [💡 묘사 포맷 가이드 (아래의 구조만 참고하고, 내용은 100% 창작해서 매번 다르게 할 것. 예시 복사 절대 금지)]
    - 포맷: [창의적인 동물상 이모지] + [독창적인 체형/비주얼 묘사] + [스타일링] + [성격/기질] + [구체적 직업]
    (올바른 예시 구조: 예민한 흑표범상 🐆 + 마라톤으로 다져진 마른 근육핏 + 올블랙 테크웨어 + 겉바속촉 츤데레 + 스타트업 백엔드 개발자)
...
9. "여우상+잔근육" 등 특정 표현이 편향적으로 등장하지 않도록, 매번 완전히 새로운 동물상, 체형, 직업, 스타일을 무작위 배합하여 출력해. 예시를 앵무새처럼 따라하면 절대 안 됨! 창의성의 한계를 보여줘.
