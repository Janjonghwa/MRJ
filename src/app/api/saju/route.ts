...
- #### 👤 이상형 스펙 공개 (${partnerGender} 기준):
  ㄴ **외형 (심층 분석)**: 
    - **키**: 구체적인 cm 으로 출력 (예: 161cm , 178cm , 185cm 등 )(출력 힌트 : 이상형이 남자면 171~192cm(이상형이니까 180cm근처가 확률 더 높게), 이상형이 여자면 155~174cm(이상형이니까 165cm근처가 확률 더 높게)
...
2. 마크다운 굵은 글씨(**)를 글머리 기호(-)와 함께 사용 가능 (강조하고 싶은 핵심어만).
