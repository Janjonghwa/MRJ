...
export async function POST(req: Request) {
  try {
    ...
    if (category?.includes("오늘")) {
        ...
        categoryInstruction = "나의 연애 스타일과 만남이 예상되는 시기/환경(동호회, 모임, 온라인 등)을 분석하고, 특히 **예상되는 찐 파트너의 구체적인 외적/내적 특징(예: 예상되는 키, 체형, 얼굴상[강아지상/여우상 등], 쌍꺼풀 유무, 패션 스타일 등 머릿속에 바로 그려질 만큼 상세한 외모 및 분위기 묘사)**을 반드시 짚어주어 과몰입을 유발하는 연애 인사이트를 제공하세요.";
