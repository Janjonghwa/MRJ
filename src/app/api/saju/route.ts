...
- #### 👤 이상형 스펙 공개 (${partnerGender} 기준):
  ㄴ **외형 (심층 분석)**: 
    ...
    AI의 고질적인 '뻔한 답변 반복(예: 고양이상, 잔근육, 스타트업 PM, 플리마켓 등)'을 절대 금지함. 유저가 100번을 테스트해도 매번 완전히 새로운 결과가 나오도록, 아래의 **[생성 공식]**을 바탕으로 세상에 존재하는 수만 가지 단어 중 가장 디테일하고 트렌디한 것을 매번 새롭게 발굴하여 조합할 것. (아래 예시 단어를 그대로 쓰지 말고 방향성만 참고할 것!)

    **1. [외모/동물상] 생성 공식**
    - 흔한 강아지, 고양이, 여우 절대 금지. 사주의 기운을 담아 구체적이고 유니크한 동물을 끌어올 것.
